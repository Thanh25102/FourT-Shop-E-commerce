...
$(document).ready(function(){
  ...
  //------- Active Nice Select --------//
    ...
    $(".active-banner-slider").owlCarousel({
        ...
        loop:true,
        nav:true,
        navText:["<img src='/FourT-Shop-E-commerce/asset/web/img/banner/prev.png'>","<img src='/FourT-Shop-E-commerce/asset/web/img/banner/next.png'>"],
        dots:false
    });
    ...
    $(".active-product-area").owlCarousel({
        ...
        loop:true,
        nav:true,
        navText:["<img src='/FourT-Shop-E-commerce/asset/web/img/product/prev.png'>","<img src='/FourT-Shop-E-commerce/asset/web/img/product/next.png'>"],
        dots:false
    });
