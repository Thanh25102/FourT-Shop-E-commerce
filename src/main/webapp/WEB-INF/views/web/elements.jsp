    ...
    <div class="main_menu">
        <nav class="navbar navbar-expand-lg navbar-light main_box">
            <div class="container">
                ...
                <a class="navbar-brand logo_h" href="index.html"><img src="<c:url value="/asset/web/img/logo.png"/>" alt=""></a>
...
<div class="whole-wrap pb-100">
    <div class="container">
        <div class="section-top-border">
            ...
            <div class="row">
                <div class="col-md-3">
                    <img src="<c:url value="/asset/web/img/elements/d"/>.jpg" alt="" class="img-fluid">
                </div>
            ...
            <div class="progress-table-wrap">
                <div class="progress-table">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"> <img src="<c:url value="/asset/web/img/elements/f1"/>.jpg" alt="flag">Canada</div>
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"> <img src="<c:url value="/asset/web/img/elements/f2"/>.jpg" alt="flag">Canada</div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                            <div class="progress">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"> <img src="<c:url value="/asset/web/img/elements/f3"/>.jpg" alt="flag">Canada</div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                            <div class="progress">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"> <img src="<c:url value="/asset/web/img/elements/f4"/>.jpg" alt="flag">Canada</div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                            <div class="progress">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"> <img src="<c:url value="/asset/web/img/elements/f5"/>.jpg" alt="flag">Canada</div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                            <div class="progress">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"> <img src="<c:url value="/asset/web/img/elements/f6"/>.jpg" alt="flag">Canada</div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                            <div class="progress">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"> <img src="<c:url value="/asset/web/img/elements/f7"/>.jpg" alt="flag">Canada</div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                            <div class="progress">
                    ...
                    <div class="table-row">
                        ...
                        <div class="country"> <img src="<c:url value="/asset/web/img/elements/f8"/>.jpg" alt="flag">Canada</div>
                        <div class="visit">645032</div>
                        <div class="percentage">
                            <div class="progress">
        ...
        <div class="section-top-border">
            ...
            <div class="row gallery-item">
                <div class="col-md-4">
                    <a href="<c:url value="/asset/web/img/elements/g1"/>.jpg" class="img-pop-up">
                        <div class="single-gallery-image" style="background: url(img/elements/g1.jpg);"></div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="<c:url value="/asset/web/img/elements/g2"/>.jpg" class="img-pop-up">
                        <div class="single-gallery-image" style="background: url(img/elements/g2.jpg);"></div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="<c:url value="/asset/web/img/elements/g3"/>.jpg" class="img-pop-up">
                        <div class="single-gallery-image" style="background: url(img/elements/g3.jpg);"></div>
                    </a>
                </div>
                <div class="col-md-6">
                    <a href="<c:url value="/asset/web/img/elements/g4"/>.jpg" class="img-pop-up">
                        <div class="single-gallery-image" style="background: url(img/elements/g4.jpg);"></div>
                    </a>
                </div>
                <div class="col-md-6">
                    <a href="<c:url value="/asset/web/img/elements/g5"/>.jpg" class="img-pop-up">
                        <div class="single-gallery-image" style="background: url(img/elements/g5.jpg);"></div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="<c:url value="/asset/web/img/elements/g6"/>.jpg" class="img-pop-up">
                        <div class="single-gallery-image" style="background: url(img/elements/g6.jpg);"></div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="<c:url value="/asset/web/img/elements/g7"/>.jpg" class="img-pop-up">
                        <div class="single-gallery-image" style="background: url(img/elements/g7.jpg);"></div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="<c:url value="/asset/web/img/elements/g8"/>.jpg" class="img-pop-up">
            ...
            <div class="col-lg-3  col-md-6 col-sm-6">
                <div class="single-footer-widget mail-chimp">
                    ...
                    <ul class="instafeed d-flex flex-wrap">
                        <li><img src="<c:url value="/asset/web/img/i1.jpg"/>" alt=""></li>
                        <li><img src="<c:url value="/asset/web/img/i2.jpg"/>" alt=""></li>
                        <li><img src="<c:url value="/asset/web/img/i3.jpg"/>" alt=""></li>
                        <li><img src="<c:url value="/asset/web/img/i4.jpg"/>" alt=""></li>
                        <li><img src="<c:url value="/asset/web/img/i5.jpg"/>" alt=""></li>
                        <li><img src="<c:url value="/asset/web/img/i6.jpg"/>" alt=""></li>
                        <li><img src="<c:url value="/asset/web/img/i7.jpg"/>" alt=""></li>
                        <li><img src="<c:url value="/asset/web/img/i8.jpg"/>" alt=""></li>
                    </ul>
                </div>
            </div>
