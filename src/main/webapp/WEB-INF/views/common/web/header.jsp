					...
					<ul class="nav navbar-nav menu_nav ml-auto">
						...
						<c:if test="${currentUser!=null}">
							<li class="nav-item submenu dropdown" style="display: flex;align-items: center;">
								...
								<c:if test="${ currentUser.avatar !=null }">
									<img src="${ currentUser.avatar }" class="rounded-circle shadow-4 nav-link dropdown-toggle" style="width:24px;">
								</c:if>
								
								<ul class="dropdown-menu">
		                            <li class="nav-item"><a class="nav-link" href="login.html">Edit profile</a></li>
									<li class="nav-item"><a class="nav-link" href="tracking.html">Order</a></li>
									<li class="nav-item"><a class="nav-link" href="elements.html">Cart</a></li>
								</ul>
							</li>
						</c:if>
						<c:if test="${ currentUser==null }">						
